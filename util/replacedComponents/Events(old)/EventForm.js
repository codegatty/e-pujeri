...
function EventForm({ onAddEvent, defaultValue, submitButtonTitle }) {
    ...
    function onChangeDate(event, selectedDate) {
        ...
        inputChangeHandler('date',selectedDateinDate);
    }
    ...
    function addHandler(){
        ...
        if (inputValues.event=== '' || inputValues.about === '' || inputValues.date === undefined ||inputValues.type === '') {
        ...
        <ScrollView>
            <View style={styles.mainContainer}>
                ...
                <InputBox label='Event Date' textConfig={{
                    ...
                    onFocus: dateHandler,
                    value:defaultValue?dateToString(inputValues.date):inputValues.date
                }} />
                {
